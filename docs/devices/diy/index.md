...
sidebar_label: Виды контроллеров
sidebar_position: 2
breadcrumbs: ["База знаний Meshtastic", "Meshtastic устройства", "Виды чипов"]
---
...
* Не оптимален для полностью автономных нод
