...
уметь работать с этими мостами (CP210x, CH34x/CH9102 и т.п.). Ниже кратко указано, где взять
...
- CP210x (Silicon Labs) - `VCP/USB-UART` драйвер
- CH34x/CH9102 (WCH) - `USB-Serial` драйвер
...
- CP210x (Silicon Labs) - драйвер `USB-UART`
- CH34x/CH9102 (WCH) - драйвер `USB-Serial`
- [CP210x USB to UART Bridge](https://www.silabs.com/products/development-tools/software/usb-to-uart-bridge-vcp-drivers)
