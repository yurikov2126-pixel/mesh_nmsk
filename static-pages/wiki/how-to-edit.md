...
description: "Пошаговая инструкция для контрибьюторов Mesh_NMSK Wiki: как править статьи, отправлять PR и соблюдать стандарты контента."
---

# Изменения в базе знаний Mesh_NMSK

Спасибо, что помогаете развивать Mesh_NMSK Wiki!  
Этот документ объясняет, как быстро внести правки в контент и что проверить перед Pull Request.
...
1. Найдите исходный файл в `docs/...` или `static-pages/...` через кнопку **«Отредактировать эту страницу»** в интерфейсе вики или напрямую в редакторе GitHub, если работаете локально. Подробности выше, в разделе 1.
...
## 7. Лицензия
- Репозиторий распространяется под [CC BY-SA 4.0](https://github.com/yurikov2126-pixel/mesh_nmsk/blob/main/LICENSE); русскоязычное описание - в [LICENSE.ru.md](https://github.com/yurikov2126-pixel/mesh_nmsk/blob/main/LICENSE.ru.md).
