...
Спасибо, что помогаете развивать Mesh-NMSK WIKI!  
...
## 7. Лицензия
- Репозиторий распространяется под [CC BY-SA 4.0](https://github.com/Mesh_NMSKRussia/yurikov2126-pixel/mesh_nmsk/blob/deployment/LICENSE); русскоязычное описание — в [LICENSE.ru.md](https://github.com/yurikov2126-pixel/mesh_nmsk/blob/deployment/LICENSE.ru.md).
